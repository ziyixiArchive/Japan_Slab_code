...
sampling_rate = 10
logfile = "/mnt/scratch/xiziyi/process_data_small/process_data_284_big.log"
RAW_DIR_HEAD = "/mnt/scratch/xiziyi/process_data_small/asdf_all_284_sub"
PROCESSED_DIR = "/mnt/scratch/xiziyi/process_data_small/asdf_all_284_processed_big"
...
def submit_job(thecommand):
    s = Slurm("process_data", {"nodes": N_node, "ntasks": N_cores,
                               "time": "24:00:00", "cpus-per-task": 1, "mem-per-cpu": "2G"})
    s.run(thecommand)
