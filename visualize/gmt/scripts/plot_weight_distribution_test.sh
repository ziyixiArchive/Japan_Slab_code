gmt begin ../figures/fig15.similarity.weightedraw pdf
    ...
    gmt makecpt -Cgray -T0/0.0001/0.00001 -Iz

    gmt psxy -St0.08c -C ../data/fig15.similarity.weightedraw
    gmt colorbar -C -DjBR+w3c/0.2c+ml+o3.0c/0.0c -By+l"similarity" -L  -S
